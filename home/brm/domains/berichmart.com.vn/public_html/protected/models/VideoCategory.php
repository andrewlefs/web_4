...
class VideoCategory extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array('Parent'=>array(self::BELONGS_TO,'VideoCategory','parent_id'),
		);
	}
	...
	public function search()
	{
        ...
        public function getCountVideo(){
            $count = Yii::app()->db->createCommand('select count(*) from videos where video_category_id like "%,'.$this->id.',%"')->queryScalar();
            return $count;
        }
}