...
class Product extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title,quantity,code,price_sell,price_buy,shipping,bog,km,hhh,bonus, alias,created, content, modified, status,image,category_id', 'required'),
			array('status, category_id,producer_id,quantity,km,hhh,bog', 'numerical', 'integerOnly'=>true),
			array('title, alias,image', 'length', 'max'=>255),
                    array('famous, reduce,view,group_product_id,donvitinh', 'numerical','allowEmpty'=>true),
                    array('material,color,type,origin,meta_key,meta_des,modified,created,image1,image2,quality,fields','length','allowEmpty'=>true),
