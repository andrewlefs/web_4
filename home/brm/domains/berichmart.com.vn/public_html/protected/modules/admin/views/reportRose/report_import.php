        ...
        <table width="949" border="0" cellspacing="1" cellpadding="0" id="table-form" class="member-table">
            ...
            <tbody class="text-center">
                <tr class="text-title">
                    ...
                    <td style="width: 180px;">Số tiền nạp</td>
                    <td>Ngày giờ nạp</td>
                    <td style="width: 180px;">Nhân viên nhập</td>
                </tr>
                <?php
                if(isset($reports))
                ...
                <?php } ?>
                <tr>
                    <td colspan="6">Tổng thu : <span style="font-weight: bold; color: red;"><?php echo number_format($total);?></span> VNĐ</td>
                </tr>
            </tbody>
        </table> 
...
$(function(){
    ...
    $('#in_excel').click(function(){
        location.href= '<?php echo getURL();?>admin/report/reportImport?d_from='+$('#d_from').val()+'&&d_to='+$('#d_to').val()+'&&user_id='+$('#user_id').val();     
    });
});
</script>