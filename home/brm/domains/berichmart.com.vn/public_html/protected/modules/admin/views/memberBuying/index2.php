<div class="top-main">
    ...
    <p>Danh sách đơn hàng trực tiếp</p>
</div><!--.top-main-->
                ...
                <table width="949" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <tr>
                               ...
                               <td><?php echo date('d/m/Y',  strtotime($item->created));?></td>
                                ...
                                <td align="center" valign="top">
                                    <a title="Xóa mục này" href="<?=getURL().'admin/memberBuying/delete/'.$item->id.'?index=2'?>" onclick="return confirm(&#039;Bạn chắc chắn muốn xóa ?&#039;);"><img src="<?php echo getURL().'images/admin/cross.png';?>"></a>                                    
                                    <a title="Sửa mục này" href="<?=getURL().'admin/memberBuying/edit/'.$item->id?>?active=1" ><img src="<?php echo getURL().'images/admin/pencil_1.png';?>"></a>
                                    <a title="<?php echo ($item->status==0)?'Kích hoạt':'Ngừng kích hoạt';?>" href="<?=getURL().'admin/memberBuying/updateStatus/'.$item->id.'?index=2';?>">
