...
<?php $form = $this->beginWidget('CActiveForm', array('id' => 'frm', 'enableAjaxValidation' => true, 'clientOptions' => array('validateOnSubmit' => true, 'validateOnChange' => true), ));?>
	<table width="949" border="0" cellspacing="1" cellpadding="0" id="table-form">
            ...
            <tr>
                <td align="left" valign="top" style="width:150px;"><?php echo $form->labelEx($Video,'file'); ?></td>
                <td align="left" valign="top">
                    <label> 
                        <?php echo $form->textField($Video,'file',array('maxlength'=>256,'class'=>'text-input')); ?>
                        <?php echo showUploadCKFinder('Video_file');?>
                        <?php echo $form->error($Video,'file'); ?>
                    </label>
                </td>
            </tr> 
            <tr>
            ...
            <tr>
                <td align="left" valign="top"><?php echo $form->labelEx($Video,'content'); ?></td>
                <td align="left" valign="top">                    
                    <?php tiny($this,array('name'=>'Video[content]','id'=>'Video_content','value'=>$Video->content,'style'=>'height:300px; width:770px;')) ?>
                    <?php echo $form->error($Video,'content'); ?>
                </td>
            </tr>
            <?php if(!$Video->isNewRecord){?>
            <tr>
                <td align="left" valign="top"><?php echo $form->labelEx($Video,'status'); ?></td>
                <td align="left" valign="top">                    
                    <?php echo $form->radioButtonList($Video,'status',array('1'=>'Đã kích hoạt','0'=>'Chưa kích hoạt')); ?>
                    <?php echo $form->error($Video,'status'); ?>
                </td>
            </tr>  
            <?php } ?>
            <tr>
                ...
                <td align="left" valign="top"><label>
                    <?php echo CHtml::submitButton($Video->isNewRecord ? 'Tạo mới' : 'Cập nhật',array('class'=>'button')); ?>
                </label></td>
            </tr>
        </table> 
<?php $this->endWidget(); ?>
