        ...
        <form id="frm" name="frm" method="post" action="">
                ...
                <table width="949" border="0" cellspacing="1" cellpadding="0">
                        <tr>
                                ...
                                <th align="left" valign="top" scope="col"><a href="#">vị trí</a></th>
                        ...
                        <tr>
                                ...
                                <td align="left" valign="top"><a href='<?=getURL()."admin/albumCategories/view/".$albumCategory['cat']->id;?>'><?=$albumCategory['separator'].$albumCategory['cat']->name?></a></td>
                                <td align="left" valign="top"><?=$albumCategory['cat']->Parent['name'];?></td>
                                <td align="center" valign="top"><?=$albumCategory['cat']->getCountAlbum();?></td>
                                ...
                                <td align="center" valign="top">
                                        <a href="<?=getURL(1).'admin/albumCategories/updateStatus/'.$albumCategory['cat']->id?>"><?=($albumCategory['cat']->status==0)?'Chưa kích hoạt':'Đã kích hoạt';?></a>
                                </td>
                                <td align="center" valign="top">
                                    <a title="Xóa mục này" href="<?=getURL().'admin/albumCategories/delete/'.$albumCategory['cat']->id?>" onclick="return confirm(&#039;Bạn chắc chắn muốn xóa ?&#039;);"><img src="<?php echo getURL().'images/admin/cross.png';?>"></a>
                                    <a title="Sửa mục này" href="<?=getURL().'admin/albumCategories/edit/'.$albumCategory['cat']->id?>" ><img src="<?php echo getURL().'images/admin/pencil_1.png';?>"></a>
                                    <a title="<?php echo ($albumCategory['cat']->status==0)?'Hiện mục này':'Không hiện mục này';?>" href="<?=getURL().'admin/albumCategories/updateStatus/'.$albumCategory['cat']->id?>">
