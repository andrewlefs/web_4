    ...
    <div class="form info_member report">        
        <table width="949" border="0" cellspacing="1" cellpadding="0" id="table-form" class="member-table">
            ...
            <tbody class="text-center">
                <tr class="text-title">
                    <td style="width: 180px;">Tên đăng nhập</td>                   
                    <td style="width: 200px;">Họ tên</td>
                    <td style="width: 180px;">Số tài khoản</td>
...
$(function(){
    $('#in_excel').click(function(){
        location.href= '<?php echo getURL();?>admin/report/reportImport?d_from='+$('#d_from').val()+'&&d_to='+$('#d_to').val();     
    });
});
</script>