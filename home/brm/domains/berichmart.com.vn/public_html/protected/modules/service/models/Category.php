	...
	public function rules()
	{
		...
		return array(
			...
			array('name, alias', 'length', 'max'=>250),
                        array('order, parent_id,show,group_product_id,level,status','numerical','allowEmpty'=>true),
                        array('meta_key, meta_des,icon,image,modified,created,alias','length','allowEmpty'=>true),
