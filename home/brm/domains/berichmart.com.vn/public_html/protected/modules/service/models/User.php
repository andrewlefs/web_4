...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('password, name', 'required'),
                        array('content,active_key,images,sex,email,phone,birth_date, created, modified,phone','length','allowEmpty'=>true),
                        array('power,status','numerical','allowEmpty'=>true),
			array('power,status', 'numerical', 'integerOnly'=>true),
