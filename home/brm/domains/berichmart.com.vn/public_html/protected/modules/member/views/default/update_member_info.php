...
<div id="formdangky">
    <center><h3 style="margin: 0px; line-height: 32px;">Thay đổi thông tin thành viên</center>
...
<table class="form_table" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr>
              ...
              <td class="form_text">                  
                  <?php echo $form->textField($member,'cmnd',array('maxlength'=>12,'style'=>'width:300px;height:px;','class'=>'form_control','disabled'=>'disabled')); ?>
