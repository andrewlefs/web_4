<?php
class CardAccount extends CActiveRecord
{
        public $captcha;
        public $newpass;
        public $confirmpass;
	...
	public function tableName()
	{
        ...
        public function checkpass($attribute,$params){
            //echo getString($this->password, 3).' : '.$this->$attribute;
             $cardaccount = $this->findByPk($this->id);
            if(getString($cardaccount->password_card, 3)!=$this->$attribute)
	...
	public function rules()
	{
		...
		return array(
			array('member_id, numbercard,created, numberaccount, modified, password_card,mobile,captcha,newpass,confirmpass,oldpass,address', 'required'),
