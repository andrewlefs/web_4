      ...
      <div class="nav-center">
        ...
        <div class="nav-bottom">
          <div class="location">
            ...
            <div class="total-member">Tổng số thành viên:<span class="red"><?php echo Yii::app()->db->createCommand('select count(*) from members')->queryScalar();?></span></div><span style="background:url(<?php echo Yii::app()->controller->module->registerImage('line-space1.png');?>) 13px 2px no-repeat; width:28px; height:25px; display:block; float:right; margin-left:-1px;"></span><div class="hotline">HOTLINE: <span class="red"><?php echo $this->sale->hotline;?></span></div>
        </div>
        <!--nav bottom--> 
      </div>
      <!--nav center-->
