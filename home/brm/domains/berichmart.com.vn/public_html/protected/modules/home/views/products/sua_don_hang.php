...
<div class="cart-page">
	<div class="continuous">
            <a href="<?php echo getURL();?>xoa-gio-hang?edit=1" class="deleteCart">Xóa toàn bộ giỏ hàng<img src="<?php echo Yii::app()->controller->module->registerImage('dash_remove_icon.png')?>" alt=""></a><a href="<?php echo getURL();?>" class="continuousBuy">Tiếp tục mua hàng<img src="template/home/images/next-icon.png" alt=""></a>
	</div>
	<form name="frmedit" action="<?php echo getURL().'home/products/EditShoppingCart?edit=1';?>" method="post" accept-charset="utf-8" id="myform" class="cssform">
        <div class="list-cart">
                    ...
                    <td colspan="8">
                        <table class="tb_form" cellpadding="0" cellspacing="0" style="width:50%; float: left;">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="personbuy[fullname]" id="fullname_b" value="<?php echo $personbuy['fullname'];?>"></td>
                            </tr>
                            <tr>
                                <td>Giới tính : </td>
                                <td>
                                    <select name="personbuy[sex]" id="sex_b">
                                        ...
                                        <option value="0" <?php echo ($personbuy['sex']==0)?'selected="selected"':'';?>>Nữ</option>
                                        <option value="1" <?php echo ($personbuy['sex']==1)?'selected="selected"':'';?>>Nam</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td>Địa chỉ : <span style="color:red; font-weight: bold;">*</span></td>
                                <td><input type="text" name="personbuy[address]" id="address_b" value="<?php echo $personbuy['address'];?>" ></td>
                            </tr>
                            <tr>
                                <td>Email : <span style="color:red; font-weight: bold;">*</span></td>
                                <td><input type="text" name="personbuy[email]" id="email_b" value="<?php echo $personbuy['email'];?>"></td>
                            </tr>
                            <tr>
                                <td>Điện thoại : <span style="color:red; font-weight: bold;">*</span></td>
                                <td><input type="text" name="personbuy[phone]" id="phone_b" value="<?php echo $personbuy['phone'];?>"></td>
                            </tr>
                            <tr>
                                <td>Di đông : </td>
                                <td><input type="text" name="personbuy[mobile]" id="mobile_b" value="<?php echo $personbuy['mobile'];?>" ></td>
                            </tr>
                            <tr>
                                <td>Fax : </td>
                                <td><input type="text" name="personbuy[fax]" id="fax_b" value="<?php echo $personbuy['fax'];?>" ></td>
                            </tr>
                            <tr>
                                <td>Ghi chú : </td>
                                <td><input type="text" name="personbuy[info]" id="info_b" value="<?php echo $personbuy['info'];?>" ></td>
                            </tr>                            
                        </table>
                        <table class="tb_form" cellpadding="0" cellspacing="0" style="width:50%;float: left;">
                            <tr>
                            ...
                            <tr>
                                <td>Họ tên : <span style="color:red; font-weight: bold;">*</span></td>
                                <td><input type="text" name="personget[fullname]" id="fullname_g" value="<?php echo $personget['fullname'];?>"></td>
                            </tr>
                            <tr>
                                <td>Giới tính : </td>
                                <td>
                                    <select name="personget[sex]" id="sex_g">
                                        <option value="">Chọn giới tính</option>
                                        <option value="0" <?php echo ($personget['sex']==0)?'selected="selected"':'';?>>Nữ</option>
                                        <option value="1" <?php echo ($personget['sex']==1)?'selected="selected"':'';?>>Nam</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td>Địa chỉ : <span style="color:red; font-weight: bold;">*</span></td>
                                <td><input type="text" name="personget[address]" id="address_g" value="<?php echo $personget['address'];?>"></td>
                            </tr>
                            <tr>
                                <td>Email : <span style="color:red; font-weight: bold;">*</span></td>
                                <td><input type="text" name="personget[email]" id="email_g" value="<?php echo $personget['email'];?>"></td>
                            </tr>
                            <tr>
                                <td>Điện thoại : <span style="color:red; font-weight: bold;">*</span></td>
                                <td><input type="text" name="personget[phone]" id="phone_g" value="<?php echo $personget['phone'];?>"></td>
                            </tr>                            
                            <tr>
                                <td>Di đông : </td>
                                <td><input type="text" name="personget[mobile]" id="mobile_g" value="<?php echo $personget['mobile'];?>"></td>
                            </tr>
                            <tr>
                                <td>Fax : </td>
                                <td><input type="text" name="personget[fax]" id="fax_g" value="<?php echo $personget['fax'];?>"></td>
                            </tr>
                            <tr>
                                <td>Ghi chú : </td>
                                <td><input type="text" name="personget[info]" id="info_g" value="<?php echo $personget['info'];?>"></td>
                            </tr>
                        </table>
                        ...
                        <table class="tb_form" cellpadding="10" cellspacing="10" style="margin:auto;">
                            ...
                            <tr>
                                <td class="thongtin activebox">
                                    ...
                                    <p class="radio"><input type="radio" class="vanchuyen" name="vanchuyen" checked="checked" value="Đến địa chỉ người nhận"></p>                                        
                                </td>
                                <td class="thongtin">
                                    <p class="radio">Khác hàng đến nhận hàng</p>
                                    <p class="radio"><input type="radio" class="vanchuyen" name="vanchuyen" value="Khác hàng đến nhận hàng"></p>     
                                </td>
                                <td class="thongtin">
                                    <p class="radio">Qua bưu điện</p>
                                    <p class="radio"><input type="radio" class="vanchuyen" name="vanchuyen" value="Qua bưu điện"></p>     
                                </td>
                                <td class="thongtin">
                                    <p class="radio">Hình thức khác</p>
                                    <p class="radio"><input type="radio" class="vanchuyen" name="vanchuyen" value="Hình thức khác"></p>     
                                </td>
                            </tr>
                        </table>
                        <p style="text-align:center; width: 100%;">
                            <span>Thời gian mong muốn nhận hàng : </span>
                            <input type="text" name="time[hi]" id="time_hi" style="width:100px;">
                            <select name="time[d]" id="time_d">
                                <option value="">Chọn ngày</option>
                                <?php for($i=1;$i<=31;$i++){?>
                                <option value="<?=$i;?>"><?=$i;?></option>
                                <?php }?>
                            </select>
                            <select name="time[m]" id="time_m">
                                <option value="">Chọn tháng</option>
                                <?php for($i=1;$i<=12;$i++){?>
                                <option value="<?=$i;?>"><?=$i;?></option>
                                <?php }?>
                            </select>
                            <select name="time[y]" id="time_y"> 
...
<script>
    ...
    $(function(){
        $('#time_hi').val('<?php echo $time['hi'];?>');
        $('#time_m').val(<?php echo $time['m'];?>);
        $('#time_d').val(<?php echo $time['d'];?>);
        $('#time_y').val(<?php echo $time['y'];?>);
        $('.thanhtoan').each(function(){
            if(this.value=='<?php echo $member_buying['thanhtoan'];?>')
                $(this).attr('checked','checked');
        })
        $('.vanchuyen').each(function(){
            if(this.value=='<?php echo $member_buying['vanchuyen'];?>')
                $(this).attr('checked','checked');
        })
