            ...
            <script>
                $(function(){
                    $('#delete').click(function(){
                        $.post("deleteFile.php",{'url':$('#gallery .download a').attr('href')},function(data){
                            if(data == 'true')
                    ...
                    $('#select').click(function(){
                        parent.getImage($('#gallery .download a').attr('href'));
                    });
                });
            </script>
    </head>
                                                    ...
                                                    while (($file = readdir($open_dir)) !== false) {
                                                        if($file != '.' && $file != '..') {  // skip self and parent pointing directories
                                                            ...
                                                            <li>
                                                                    ...
                                                                    <div class="caption">
                                                                            <div class="download">
                                                                                    <a href="<?php echo $fullpath;?>">Download Original</a>
                                                                            </div>
